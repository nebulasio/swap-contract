...
class Online extends OnlineBase {
    ...
    get _source() {
        let p = path.join(__dirname, '../../../build/output/NUSDT.js')
        if (!fs.existsSync(p)) {
            throw p + ' not found.'
        }
    ...
    async _deploy() {
        try {
            return await this._getDeployResult('NUSDT', await this.nebUtil.oneKeyDeploy(this._account, this._source, Array.from(arguments)))
        } finally {
            this._reset()
        }
    }
    ...
    async name() {
        try {
            return await this._getTxResult('NUSDT.name', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'name', Array.from(arguments)))
        } finally {
            this._reset()
        }
    }
    ...
    async symbol() {
        try {
            return await this._getTxResult('NUSDT.symbol', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'symbol', Array.from(arguments)))
        } finally {
            this._reset()
        }
    }
    ...
    async decimals() {
        try {
            return await this._getTxResult('NUSDT.decimals', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'decimals', Array.from(arguments)))
        } finally {
            this._reset()
        }
    }
    ...
    async totalSupply() {
        try {
            return await this._getTxResult('NUSDT.totalSupply', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'totalSupply', Array.from(arguments)))
        } finally {
            this._reset()
        }
    }
    ...
    async balanceOf(owner) {
        try {
            return await this._getTxResult('NUSDT.balanceOf', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'balanceOf', [owner]))
        } finally {
            this._reset()
        }
    }
    ...
    async mint(value) {
        try {
            return await this._getTxResult('NUSDT.mint', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'mint', [value]))
        } finally {
            this._reset()
        }
    }
    ...
    async transfer(to, value) {
        try {
            return await this._getTxResult('NUSDT.transfer', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'transfer', [to, value]))
        } finally {
            this._reset()
        }
    }
    ...
    async transferFrom(from, to, value) {
        try {
            return await this._getTxResult('NUSDT.transferFrom', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'transferFrom', [from, to, value]))
        } finally {
            this._reset()
        }
    }
    ...
    async approve(spender, currentValue, value) {
        try {
            return await this._getTxResult('NUSDT.approve', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'approve', [spender, currentValue, value]))
        } finally {
            this._reset()
        }
    }
    ...
    async allowance(owner, spender) {
        try {
            return await this._getTxResult('NUSDT.allowance', await this.nebUtil.oneKeyCall(this._account, this._contractAddress, this._value, 'allowance', [owner, spender]))
        } finally {
            this._reset()
        }
    }
